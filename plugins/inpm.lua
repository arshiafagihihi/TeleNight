...
if to == 'user' or service or is_admin1(msg) and to == "chat" or to == "channel" then
	...
	if matches[1] == 'help' and msg.to.type == 'user' or matches[1] == 'pmhelp' and is_admin1(msg) and msg.to.type ~= 'user' then
		...
		text = "Welcome to TeleNight!\n\nTo get a list of TeleNight groups use /chats or /chatlist for a document list of chats.\n\nTo get a new TeleNight group, contact a support group, check out our channel:\n\n@TeleNight_ch [Persian]\n\nThanks for using @TeleNight!"
     	return text
    end
